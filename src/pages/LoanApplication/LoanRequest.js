      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-6">
        ...
        <div>
          ...
          <Controller
            ...
            render={({ field }) => (
              <input
                className="block w-full text-md font-normal text-md font-normal appearance-none rounded-md border border-gray-300 px-3 py-2 placeholder-gray-400 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm disabled:cursor-not-allowed disabled:opacity-50"
                {...field}
                type="number"
              />
            )}
